...
- HTTP/3 (QUIC) support, opt-in via `ProxyServer.EnableHttp3 = true` (.NET 6+, requires MsQuic; see the [HTTP/3 wiki](https://github.com/justcoding121/titanium-web-proxy/wiki/HTTP-3) for setup and limitations)
