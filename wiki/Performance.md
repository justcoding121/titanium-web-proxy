...
Unary Echo **RPC/s** @ c=64 over **H2 TLS → h2c** (edge TLS, cleartext H2 origin). Peers: Titanium, YARP, HAProxy, Envoy. nginx: *Not possible (no H2 upstream)*. Mode: `compare-grpc` (`*-grpc-h2c`). Win/Linux from prior paste; macOS @ `a495a9ae` — [34557768163](https://github.com/justcoding121/titanium-web-proxy/actions/runs/34557768163).
...
| macOS | **14,333**<br><sub>(90 MiB / 23.8% CPU)</sub> | **9,316**<br><sub>(132 MiB / 34.8% CPU)</sub> | *Not possible (no H2 upstream)* | **0**<br><sub>(65 MiB / 17.6% CPU)</sub> | **0**<br><sub>(80 MiB / 20.6% CPU)</sub> |
...
| OS | Titanium | YARP | nginx | HAProxy | Envoy |
|---|---:|---:|---:|---:|---:|
| Windows | **25,713**<br><sub>(144 MiB / 42.9% CPU)</sub> | **0**<br><sub>(167 MiB / 20.9% CPU)</sub> | *Not possible (no RFC 8441)* | *Not possible* | *Not possible* |
...
| macOS | **11,061**<br><sub>(384 MiB / 43.3% CPU)</sub> | **0**<br><sub>(132 MiB / 17.7% CPU)</sub> | *Not possible (no RFC 8441)* | **10,080**<br><sub>(66 MiB / 33.1% CPU)</sub> | **0**<br><sub>(73 MiB / 0.3% CPU)</sub> |
